...
function ken_cens_com_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'My_development_theme' ),
		'footer' => esc_html__( 'Footer Menu', 'My_development_theme' ),
	) );
...
{
	global $post;
	// return $excerpt ."<a href=". get_permalink($post->ID) . ">...[閱讀更多]</a>";

	// return $excerpt ."<a href=". get_permalink() . ">\n[閱讀更多]</a>";
	return "<a href=". get_permalink() . ">...[閱讀更多]</a>";
